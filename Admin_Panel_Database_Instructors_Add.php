            ...
            <div class="col-lg-12">
                <h2 class="tabTitle">Database Management - Instructor Database</h2>
                    <div class="content">
                        ...
                        <div class="col-lg-12">
                                <form class="row" action="./Admin_Panel_Database_Instructors_Add.php" method="post">
                                    <div class="col-lg-2">
                                    </div>
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        <input class="form-control" type="text" name="passwordi">
                                    </div>

                                    <div class="col-lg-2">
                                        <br>
                                        <button class="btn btn-success" type="submit" name="addInstructor">Add Entry</button>
                                    </div>
                                    ...
                                    <?php
                                        function addB($First_Name,$Last_Name,$Username,$passwordi){
                                            ...
                                            if($First_Name == NULL || $Last_Name == NULL || $Username == NULL || $passwordi == NULL){
                                                echo "<br><br>
                                                      <div class=\"col-lg-12\">
