...
<body>
    ...
    <div class="container d-flex justify-content-center">
            ...
            <div class="col-lg-9">
                <h2 class="tabTitle">Quiz Given</h2>
                <div class="content">
                    <div class="row">
                        <a href="./Instructor_Quiz_View.php"><button class="btn btn-secondary float-end">Back</button></a><br> 
                        ...
                        <table class="table table-striped border">
                            ...
                            <form action="Instructor_Quiz_Check.php" method="post">
                                <?php
                                include_once('student.php');
                                //query
                                ...
                                $sqlll = "SELECT workID,Title,descriptions,deadline,xp_reward,workType
                                        FROM coursework
                                        WHERE courseID = $value AND workType = 'Quiz' ";
