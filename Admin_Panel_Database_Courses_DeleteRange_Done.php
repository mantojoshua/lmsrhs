                        ...
                        <div class="row">
                            ...
                            <?php
                                ...
                                while($row = $result->fetch_assoc()){
                                    ...
                                    $IDnumSecond = $row['IDnumSecond'];
                                }

                                $sql = "DELETE FROM instructor_courses WHERE courseID BETWEEN '$IDnumber' AND '$IDnumSecond'";
                                $result = $conn->query($sql);
                                $conn->close();

                                echo"
                                <div class=\"col-lg-12\">
                                    <strong>Deletion Confirmed. Press Back button to go back to the database</strong>
                                </div>
                                ";
                                resetTemp();
                                function resetTemp(){
