...
<body>
    ...
    <div class="container d-flex justify-content-center">
        ...
        <div class="col-md-12">
            <h2 class="tabTitle">Assigment Given</h2>
            <div class="content">
                <div class="row">
                    <a href="./Instructor_Assignment_View.php"><button class="btn btn-secondary float-end">Back</button></a><br>
                    ...
                    <table class="table table-striped table-responsive">
                        ...
                        <form action="Instructor_Assignment_Check.php" method="post">
                            <?php
                            include_once('student.php');
                            //query
                            ...
                            $sqlll = "SELECT workID,Title,descriptions,deadline,xp_reward,workType
                                        FROM coursework
                                        WHERE courseID = $value AND workType = 'Assignment' ";
