...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h2 class="tabTitle">Instructor Verification</h2>
                    <div class="content">
                        <div class="row">
                            <div class="col-lg-12">
                                <a href="./Admin_Panel_Database.php"><button class="btn btn-primary">Back</button></a><br><br>
                            </div>
                           ...
                           <?php
                            ...
                            $sql = "SELECT * FROM instructor WHERE verified=false";
                            ...
                            while($row = $result->fetch_assoc()){
                                echo"
                                    ...
                                    <div class=\"col-lg-2\">
                                        <span>".$row['passwordi']."</span>
                                    </div>
                                ";
                                echo"
                                <div class=\"col-lg-2\">
                                <form id = \"insverify\" action=\"insver.php\" method=\"post\"><input type=\"hidden\" name=\"instructorID\" value=\"".$row['instructorID']."\"><button type=\"submit\" class=\"btn btn-primary\"name=\"verify\">Verify</button></form>
                                </div>
                                <hr>
                                ";
                            }
    ...
    <div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                ...
                <form class="row" action="Admin_Panel_Database_Instructors_Update.php" method="post">
                    <div class="col-lg-12">
                        <Label>Enter the instructorID number of the entry you wish to change:</Label><br>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                <form class="row" action="Admin_Panel_Database_Instructors_Delete.php" method="post">
                    <div class="col-lg-12">
                        <Label>Enter the instructorID number of the entry you wish to delete:</Label><br>
                        <input type="text" name="IDnumber" class="form-control"><br>
                    </div>
    ...
    <div class="modal fade" id="deleteRangeModal" tabindex="-1" role="dialog" aria-labelledby="deleteRangeModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <form action="./Admin_Panel_Database_Instructors_DeleteRange.php" method="post" class="row">

                        <div class="col-lg-12">
                            <Label>Enter the range of the instructorID numbers of the entries you wish to delete:</Label><br><br>
                        </div>
    ...
    <div class="modal fade" id="searchModal" tabindex="-1" role="dialog" aria-labelledby="searchModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                <form class="row" action="Admin_Panel_Database_Instructors_Search.php" method="post">
                    <div class="col-lg-12">
                        <Label>Choose a single column to search by</Label>
                        <select name="column">
                            <option value="instructorID">InstructorID</option>
    ...
    <div class="modal fade" id="resetModal" tabindex="-1" role="dialog" aria-labelledby="resetModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <form class="row" action="Admin_Panel_Database_Instructors_Truncate.php" method="post">
                        <div class="col-lg-12">
