...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h2 class="tabTitle">Database Management - Course Database</h2>
                    <div class="content">
                        <div class="row">
                            <div class="col-lg-12">
                            ...
                            <div class="col-lg-10">
                                ...
                                <a href="./Admin_Panel_Database_Courses_Add.php"><button class="btn btn-success">Add Item</button></a>
                            ...
                            <?php
                                ...
                                $sql = "SELECT * FROM instructor_courses WHERE $column = '$SearchValue'";
   ...
   <div class="modal fade" id="searchModal" tabindex="-1" role="dialog" aria-labelledby="searchModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                <form class="row" action="Admin_Panel_Database_Courses_Search.php" method="post">
                    <div class="col-lg-12">
                        ...
                        <select name="column">
                            ...
                            <option value="course_code">Corse Code</option>
                        </select><br><br>
