...
<body>
    ...
    <div class="container">
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-lg-9">
                <h2 class="tabTitle">Assigment Report</h2>
                <div class="content">
                    <div class="row">
                        <a href="./Instructor_Assignment_View.php"><button class="btn btn-secondary float-end">Back</button></a><br><br>
                        ...
                        // $workvalue=$_SESSION['worksession'];
                        ...
                        if (!empty($result) && $result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "
                                    <td>
                                        <form id = \"insgrade\" action=\"Instructor_Grade_Assigment.php\" method=\"post\">
                                        <input type=\"hidden\" name=\"studentID\" value=\"" . $row['studentID'] . "\">
                                    ...
                                    <td>
                                        <button type=\"submit\" class=\"btn btn-success\"name=\"grade\">Submit</button></form>
                                    </td>";
                                echo "</tr>";
                            }
                        } else {
