                ...
                <h2 class="tabTitle">Database Management - Student Database</h2>
                    <div class="content">
                        <div class="row">
                            ...
                            <div class="col-lg-10">
                                <form action="Admin_Panel_Database_Students_DeleteRange_Done.php" method="post">
                            ...
                            <?php
                               ...
                               include('student.php');
                                $sql = "SELECT * FROM student where studentID BETWEEN '$IDnumber' AND '$IDnumSecond'";
                                $result = $conn->query($sql);
                                ...
                                echo
                                   ...
                                   <div class=\"col-lg-2\">
                                    ...
                                    <div class=\"col-lg-10\">
                                        If the fields below the label is empty then you have entered an invalid range<br>
                                    </div>
