...
<head>
    <meta charset="utf-8">
    <title>Educatum Instructor Training</title>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="">
                    <?php
                    include_once('student.php');
                    $sql = "SELECT * FROM student ORDER BY XP asc";
                    $result = $conn->query($sql);
...
<script>
    ...
    document.getElementById("spin").style.width = levelFill + "%";
