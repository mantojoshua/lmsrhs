...
<body>
    ...
    <div class="container d-flex justify-content-center">
            <div class="col-md-10">
                <h2 class="tabTitle">Lesson Given</h2>
                <div class="content">
                    <div class="row">
                        <a href="./Instructor_Quest.php"><button class="btn btn-secondary float-end">Back</button></a><br> 
                        If the Page is blank, then there is no current lesson created in that course<br>
                        <table class="table table-striped border">
                            ...
                            <form action="Instructor_Post_Update.php" method="post">
                            <?php
include_once('student.php');
...
$sqlll = "SELECT workID,Title,descriptions,deadline,xp_reward,workType
            FROM coursework
            WHERE courseID = $value AND workType = 'Lesson' ";
...
while ($row = $result->fetch_assoc()) {
    ...
    echo "<td><form method=\"POST\" action=\"Instructor_Post_Update.php\">";
    echo "<input type=\"hidden\" name=\"workID\" value=\"" . $row['workID'] . "\">";
    echo "<button type=\"submit\" class=\"btn btn-primary\" name=\"wname\" onclick=\"saveWorkID(" . $row['workID'] . ")\">Edit</button>";
    echo "</form></td>";
    echo "</tr>";
}
...
?>
            ...
            <script>
function saveWorkID(workID) {
    // Send an AJAX request to a PHP script that updates the session
