...
<body>
    ...
    <div class="container">
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-lg-9">
                <h2 class="tabTitle">Exam Report</h2>
                <div class="content">
                    <div class="row">
                        <a href="./Instructor_Exam_View.php"><button class="btn btn-secondary float-end">Back</button></a><br><br>
                        ...
                        if (!empty($result) && $result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "
                                    <td>
                                        <form id = \"insgrade\" action=\"Instructor_Grade_Exam.php\" method=\"post\">
                                        <input type=\"hidden\" name=\"studentID\" value=\"" . $row['studentID'] . "\">
