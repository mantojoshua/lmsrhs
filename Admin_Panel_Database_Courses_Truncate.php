                    ...
                    <div class="content">
                        <div class="row">
                            ...
                            <div class="col-lg-11">
                                ...
                                <?php
                                    include('student.php');
                                    $sql = "SELECT COUNT(courseID) FROM instructor_courses";
                                    $result = $conn->query($sql);
                                    while($row = $result->fetch_assoc()){
                                        echo "There are <strong>".$row['COUNT(courseID)']."</strong> entries about to be permanently deleted.";
                                    }
                                ?>
                            ...
                            <div class="col-lg-11">
                                <form method="post">
                                    <br>
                                    <input type="submit" name="resetCourses" class="btn btn-danger" value="TRUNCATE instructor_courses Table" />
                                </form>

                                    <?php
                                        include_once('student.php');

                                        if(array_key_exists('resetCourses', $_POST)) {
                                            resetCourses();
                                        }
                                        
                                        function resetCourses(){
                                            include('student.php');
                                            $sql = "TRUNCATE instructor_courses";
                                            $result = $conn->query($sql);
                                            $sql = "ALTER TABLE instructor_courses AUTO_Increment = 1";
                                            $result = $conn->query($sql);
                                            $conn->close();
