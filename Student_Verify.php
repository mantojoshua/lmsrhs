...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h2 class="tabTitle">Student Verification</h2>
                    <div class="content">
                        <div class="row">
                            ...
                            <?php
                                 ...
                                 $sql = "SELECT * FROM student WHERE verified=false";
 ...
 <div class=\"col-lg-1\">
                                    ...
                                    echo"
                                    <div class=\"col-lg-1\">
                                    <form id = \"stverify\" action=\"stuver.php\" method=\"post\"><input type=\"hidden\" name=\"studentID\" value=\"".$row['studentID']."\"><button type=\"submit\" class=\"btn btn-primary\"name=\"verify\">Verify</button></form>
                                    </div>
                                    <hr>
                                    ";
                                 };
