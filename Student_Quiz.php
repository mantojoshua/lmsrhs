            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        $sql = "SELECT * from coursework inner join instructor on coursework.instructorID = instructor.instructorID inner join  instructor_courses on coursework.courseID = instructor_courses.courseID WHERE workType = 'Quiz' AND coursework.courseID IN (SELECT courseID FROM enrollments WHERE studentID = $idstudentsearch) AND coursework.workID NOT IN (SELECT workID FROM student_work WHERE studentID = $idstudentsearch) AND coursework.courseID = $value";
                        $result = $conn->query($sql);
                        if (!$result) {
                            echo "Query Error";
                            exit();
                        ...
                        echo "There are <strong>" . $num . "</strong> current Quiz to do";
                        ...
                        <div class=\"quest col-md-12 text-center\">
                         ...
                         <div class=\"row\">
                             ...
                             <div class=\"col-md-12 d-flex justify-content-center\">
                                <form action=\"Student_Upload_Quiz.php\" enctype=\"multipart/form-data\" method=\"post\">
