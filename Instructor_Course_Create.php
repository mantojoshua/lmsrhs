...
<head>
    <meta charset="utf-8">
    <title>Educatum Course Creation</title>
...
<body>
    ...
    <div class="container d-flex justify-content-center">
        <div class="col-md-8">
            <h2 class="tabTitle">Create Course</h2>
            <div class="content">
                <form action="Instructor_Course_Create.php" method="post">
                    <div class="row">
                        <div class="col-lg-6">
                            <strong><label class="clabel"> Subject Name</label></strong>
                            <br>
                            <input class="sName form-control" type="text" name="course_Name"> <br>
                        </div>

                        <div class="col-lg-6">
                            <strong><label class="clabel">Course Code</label></strong> <br>
                            <input class="form-control" type="text" name="course_code">
                        </div>

                        <div class="col-lg-12">
                            <strong><label class="clabel">Subject Description</label></strong>
                            <br>
                            <textarea class="descBox form-control" name="course_Description" id=""></textarea> <br>
                            <br>
                        </div>

                        <div>
                            <input class="btn btn-success btn-outline-dark btn-lg text-white float-end" type="submit" name="createCourse" value="Create Course">
                        </div>
                    </div>
                    ...
                    function addB($instructorID, $course_Name, $course_Description, $course_code)
                    {
                        ...
                        if ($result == TRUE) {
                            ...
                            $sql = "INSERT INTO user_log (username, userAction,userTimestamp)
                                    VALUES ('$inslogin', 'created a course:$course_Name',now())";
                            $result = $conn->query($sql);
                    ...
                    if (isset($_POST['createCourse'])) {
                        echo addB($row["instructorID"], $_POST['course_Name'], $_POST['course_Description'], $_POST['course_code']);
                    }
                    ?>
